document.addEventListener("DOMContentLoaded", function () {
    ...
    // Fungsi untuk membuat elemen daftar restoran
    function createRestaurantElement(restaurant) {
      const restaurantElement = document.createElement("div");
      restaurantElement.classList.add("restaurant");
  
      // Menampilkan nama, gambar, dan deskripsi (pilih salah satu: kota, rating, atau deskripsi)
    ...
    // Memanggil fungsi untuk menampilkan daftar restoran
